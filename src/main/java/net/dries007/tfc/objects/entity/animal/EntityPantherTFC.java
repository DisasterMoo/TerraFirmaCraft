...
public class EntityPantherTFC extends EntityAnimalMammal implements IMob
{
    ...
    class AIPanic extends EntityAIPanic
    {
        ...
        {
            return (EntityPantherTFC.this.isChild() || EntityPantherTFC.this.isBurning()) && super.shouldExecute();
        }
    }
    ...
    class AIHurtByTarget extends EntityAIHurtByTarget
    {
        ...
        {
            super(EntityPantherTFC.this, false);
        }
    ...
    class AIAttackPlayer extends EntityAINearestAttackableTarget<EntityPlayer>
    {
        ...
        {
            super(EntityPantherTFC.this, EntityPlayer.class, 20, true, true, null);
        }
        ...
        public boolean shouldExecute()
        {
            ...
            else
            {
                ...
                EntityPantherTFC.this.setAttackTarget(null);
                return false;
            }
        }
